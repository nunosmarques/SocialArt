<?php
class ArtesanatoModel extends Methods {
	...
	public function getProduct(){
		if($this->counter == 0){
			...
			$clause = array("Categoria_CategoriaID" => "4");
	...
	public function pagination(){
		echo '<a class="text25px" href="'.HOME_URI.'/artesanato/index/pagina-1">&laquo;</a>
				<a class="text25px" href="'.HOME_URI.'/artesanato/index/pagina-'.($this->getActualPage() > 1 ? ($this->getActualPage()-1) : 1).'">&lsaquo;</a>';
		for($i = 1; $i <= $this->getTotalPages(); $i++){		
					echo '<a href="'.HOME_URI.'/artesanato/index/pagina-'.$i.'" class="page-num">'.$i.'</a>';
		}
		echo '<a class="text25px" href="'.HOME_URI.'/artesanato/index/pagina-'.($this->getActualPage() < $this->getTotalPages() ? ($this->getActualPage()+1) : $this->getTotalPages()).'">&rsaquo;</a>
			  <a class="text25px" href="'.HOME_URI.'/artesanato/index/pagina-'.$this->getTotalPages().'">&raquo;</a>';
