<?php
class HomeModel extends Methods {
	...
	public function getProduct(){
			$clause = array("Categoria_CategoriaID" => "");
			$results = $this->db->selectLimit("produto", false, "", "Like", NULL, 0, 12, "dataAdicionado DESC");
			if(count($results) > 0){
				$i = 1;
				...
				echo '<h2 class="h4center">Não existem artigos</h2>';
			}
