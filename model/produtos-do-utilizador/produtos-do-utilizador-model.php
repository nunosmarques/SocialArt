<?php
class ProdutosDoUtilizadorModel extends Methods {
	...
	public function getProduct(){
		if($this->counter == 0){
			...
			$clause = array("User_userID" => $this->params[1]);
	...
	public function pagination(){
		echo '<a class="text25px" href="'.HOME_URI.'/produtos-do-utilizador/index/pagina-1/'.$this->params[1].'">&laquo;</a>
				<a class="text25px" href="'.HOME_URI.'/produtos-do-utilizador/index/pagina-'.($this->getActualPage() > 1 ? ($this->getActualPage()-1) : 1).'/'.$this->params[1].'">&lsaquo;</a>';
		for($i = 1; $i <= $this->getTotalPages(); $i++){
					echo '<a href="'.HOME_URI.'/produtos-do-utilizador/index/pagina-'.$i.'/'.$this->params[1].'" class="page-num">'.$i.'</a>';
		}
		echo '<a class="text25px" href="'.HOME_URI.'/produtos-do-utilizador/index/pagina-'.($this->getActualPage() < $this->getTotalPages() ? ($this->getActualPage()+1) : $this->getTotalPages()).'/'.$this->params[1].'">&rsaquo;</a>
			  <a class="text25px" href="'.HOME_URI.'/produtos-do-utilizador/index/pagina-'.$this->getTotalPages().'/'.$this->params[1].'">&raquo;</a>';
	...
	public function getUserName(){
		...
		//($table, $field, $where, $array_filter, $where_sign, $where_condition, $orderby)
		$username = $this->db->selectWConditions("user", "firstname, lastname", true, $data, "=", "", "firstname DESC");
