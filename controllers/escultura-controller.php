<?php
/**
 * Classe EsculturaController
 * Controller da página de Escultura
 *
 * @package SocialArt
 * @version 1.0
 */
class EsculturaController extends MainController{
	...
	*/
	public function index() {
		// Título da página
		$this->title = 'Escultura';

		// Parametros da função
		$parametros = ( func_num_args() >= 1 ) ? func_get_arg(0) : array();

		// Carrega o modelo para este view
		$modelo = $this->load_model( '/escultura/escultura-model' );
		...
		require ABSPATH . '/views/escultura/escultura-view.php';
		
		//Altera o background do botão do menu
		echo "<script> menu_switch(3); </script>";
