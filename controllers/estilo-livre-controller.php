 ...
 * @version 1.0
 */
class EstiloLivreController extends MainController{
	...
	*/
	public function index() {
		...
		$modelo = $this->load_model( '/estilo-livre/estilo-livre-model' );
		...
		require ABSPATH . '/views/estilo-livre/estilo-livre-view.php';
		
		//Altera o background do botão do menu
		echo "<script> menu_switch(5); </script>";
