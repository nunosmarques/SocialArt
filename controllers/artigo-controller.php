<?php
/**
 * Classe ArtigoController
 * Controller da página do Artigo
 *
 * @package SocialArt
 * @version 1.0
 */
class ArtigoController extends MainController{
	...
	*/
	public function index() {
		...
		$modelo = $this->load_model( '/artigo/artigo-model' );
		...
		require ABSPATH . '/views/artigo/artigo-view.php';
