 ...
 * @version 1.0
 */
class ArtesanatoController extends MainController{
	...
	*/
	public function index() {
		// Título da página
		$this->title = 'Artesanato';

		// Parametros da função
		$parametros = ( func_num_args() >= 1 ) ? func_get_arg(0) : array();

		// Carrega o modelo para este view
		$modelo = $this->load_model( '/artesanato/artesanato-model' );
		...
		require ABSPATH . '/views/artesanato/artesanato-view.php';
		
		//Altera o background do botão do menu
		echo "<script> menu_switch(4); </script>";
