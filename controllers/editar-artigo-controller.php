<?php
/**
 * Classe EditarArtigoController
 * Controller da página para Editar Artigo
 *
 * @package SocialArt
 * @version 1.0
 */
class EditarArtigoController extends MainController{
	...
	*/
	public function index() {
		// Título da página
		$this->title = 'Editar Artigo';

		// Parametros da função
		$parametros = ( func_num_args() >= 1 ) ? func_get_arg(0) : array();

		// Carrega o modelo para este view
		$modelo = $this->load_model( '/editar-artigo/editar-artigo-model' );
		...
		require ABSPATH . '/views/editar-artigo/editar-artigo-view.php';
